            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="">
                            <!-- Begin: become an author -->
                            <div class="card mt-5">
                                <div class="row">
                                    <div class="col-12 col-lg-6 text-center py-10">
                                        <img src="assets/media/svg/card-logos/agency.svg" alt="">
                                        <div class="mt-17">
                                            <h1 class="fs-2x text-gray-900 mb-2">Become An Author</h1>
                                            <div class="fs-6 text-gray-600 fw-semibold w-300px mx-auto">Authors can join
                                                UI
                                                Market by
                                                invitation or by applying using the form below.</div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div
                                            class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 p-20 px-lg-10 px-xl-20 py-lg-20 mx-auto">
                                            <!--begin::Wrapper-->
                                            <div
                                                ...
                                                <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework"
                                                    ...
                                                    <div class="text-center mb-11">
                                                        <!--begin::Title-->
                                                        <h1 class="text-gray-900 fw-bolder mb-3">Apply to open a shop
                                                        </h1>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--begin::Heading-->
                                                    ...
                                                    <div class="fv-row mb-8 fv-plugins-icon-container">
                                                        <!--begin::Email-->
                                                        <input type="text"
                                                            placeholder="Link to portfolio or product example"
                                                            name="link-to-portfolio" autocomplete="off"
                                                    ...
                                                    <div class="fv-row mb-8 fv-plugins-icon-container">
                                                        ...
                                                        <input type="text" placeholder="Additional information"
                                                            name="Additional-information" autocomplete="off"
                                                            class="form-control bg-transparent">
                                                        <!--end::Email-->
                                                        <div
                                                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                        ...
                                        <div
                                            class="d-none bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                                            <!--begin::Wrapper-->
                                            <div
                                                class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                                                <!--begin::Form-->
                                                <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework"
                                                    ...
                                                    data-kt-redirect-url="index.html" action="#">
                                                    <!--begin::Heading-->
                                                    <div class="text-justify mb-11">
                                                        <!--begin::Title-->
                                                        <h1 class="text-gray-900 fw-bolder mb-3">Application under
                                                            review
                                                        </h1>
                                                        <!--end::Title-->
                                                        <div class="fs-6 text-gray-600 fw-semibold mt-8">Thank you for
                                                            submitting your application to become a part of the UI
                                                            Market
                                                            family.</div>
                                                        <div class="fs-6 text-gray-600 fw-semibold mt-8">Your
                                                            application is
                                                            undergoing a thorough review, and we will be in touch with
                                                            you
                                                            via email within the next 1-3 business days with our
                                                            decision
                                                            and any subsequent steps.</div>
                                                    </div>
                                                    <!--begin::Heading-->
                            ...
                            <div class="card my-5 p-10">
                                ...
                                <div class="m-0">
                                    <!--begin::Title-->
                                    <h4 class="fs-1 text-gray-800 w-bolder">Frequesntly Asked Questions</h4>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <p class="fw-semibold fs-4 text-gray-600 mt-7">First, a disclaimer - the entire
                                        process
                                        of writing a blog post often takes more than a couple of hours, even if you can
                                        type
                                        eighty words as per minute abd your writing skills are sharp.</p>
                                    <!--end::Text-->
                                </div>
                                <!--end::Description-->
                                <div>
                                    <!--begin::Accordion-->
                                    <h4 class="fs-3 text-gray-800 w-bolder mt-12">Buying Product</h4>
                                    <!--begin::Section-->
                                    <div class="m-0">
                                        <!--begin::Heading-->
                                        <div class="d-flex align-items-center collapsible py-3 toggle mb-0"
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">What is the acceptance
                                                criteria?</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                        ...
                                        <div id="kt_job_1_1" class="collapse show fs-6 ms-1">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10 mb-n1">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <div class="text-gray-600 fw-semibold fs-6">Experience with
                                                        JavaScript
                                                    </div>
                                                    <!--end::Label-->
                                                </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10 mb-n1">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <div class="text-gray-600 fw-semibold fs-6">Good time-management
                                                        skills
                                                    </div>
                                                    <!--end::Label-->
                                                </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10 mb-n1">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <div class="text-gray-600 fw-semibold fs-6">Experience with React
                                                    </div>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Item-->
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10 mb-n1">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <div class="text-gray-600 fw-semibold fs-6">Experience with HTML /
                                                        CSS
                                                    </div>
                                                    <!--end::Label-->
                                                </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10 mb-n1">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <div class="text-gray-600 fw-semibold fs-6">Experience with REST API
                                                    </div>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Item-->
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10">
                                                    ...
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <div class="text-gray-600 fw-semibold fs-6">Git knowledge is a plus
                                                    </div>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Item-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">How much do I earn for
                                                sales?</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">When and how do I get
                                                paid?</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">How long will it take
                                                to
                                                review my application?</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin::Body-->
                                ...
                                <div>
                                    <!--begin::Accordion-->
                                    <h4 class="fs-3 text-gray-800 w-bolder mt-12">Installation</h4>
                                    <!--begin::Section-->
                                    <div class="m-0">
                                        <!--begin::Heading-->
                                        <div class="d-flex align-items-center collapsible py-3 toggle mb-0"
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">How many people can in
                                                support?</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">How long is the
                                                warrianty?
                                            </h4>
                                            <!--end::Title-->
                                        </div>
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">How fast is the
                                                installation?</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                        ...
                        <!-- begin:: success alert -->
                        <div class="d-none">
                            <div class="card card-flush h-xl-100 mt-6">
                                <div class="row">
                                    <div class="col-5 text-center py-18">
                                        <div class="mb-14 mt-7">
                                            <h1 class="fs-2x text-gray-900 mb-2">Withdrawal Successful</h1>
                                            <div class="fs-4x text-success fw-semibold w-300px mx-auto">$100</div>
                                        </div>
                                        <img src="assets/media/svg/card-logos/payment_by_phone.svg" alt="">

                                    </div>
                                    <div class="col-7 p-14">
                                        <div class="overflow-auto pb-5">
                                            <!--begin::Notice-->
                                            <div
                                                class="notice d-flex flex-column bg-gray-200 rounded border border-gray-300 border-dashed min-w-lg-600px flex-shrink-0 p-10">
                                                <!--begin::Wrapper-->
                                                <h4 class="text-gray-600 fw-bold">PAYMENT DETAILS
                                                </h4>

                                                <!--begin::Content-->
                                                <div class="mb-3 mb-md-0 fw-semibold mt-6">
                                                    <div class="fs-6 text-gray-700 mb-1">Paypal:
                                                    </div>
                                                    <h4 class="text-gray-900 fw-bold">codelabpay@codelab.co
                                                    </h4>
                                                </div>

                                                <div class="mb-3 mb-md-0 fw-semibold mt-6">
                                                    <div class="fs-6 text-gray-700 mb-1">Account:
                                                    </div>
                                                    <h4 class="text-gray-900 fw-bold">Nl24IBAN34553477847370033AMB
                                                        NLANBZTC
                                                    </h4>
                                                </div>

                                                <div class="mb-3 mb-md-0 fw-semibold mt-6">
                                                    <div class="fs-6 text-gray-700 mb-1">Payment Date:
                                                    </div>
                                                    <h4 class="text-gray-900 fw-bold">09:43, 14 May 2024
                                                    </h4>
                                                </div>
                                                <!--end::Content-->
                                                <!--end::Wrapper-->
                                        ...
                                        <div class="d-flex justify-content-end py-6">
                                            <a href="#" class="btn btn-light btn-active-light-primary me-3">Next
                                                transation</a>
                                            <a href="index.php" class="btn btn-primary  px-6">Home</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-none">
                            <div
                                class="d-flex flex-column container-xxl mt-12 justify-content-center align-items-center">
                                <h1 class="page-heading text-gray-900 fw-bold fs-1 m-0 mx-auto">
                                    Sorry for the inconvenience, but our system is currently down for maintenance.
                                </h1>
                                <span class="page-heading text-gray-900 fw-bold fs-1 mt-2 mx-auto">Please try again
                                    later.</span>
                                <img class="w-250px h-250px my-20" src="assets/media/svg/card-logos/E_statistics.svg"
                                    alt="">
                                <a href="index.php" class="btn btn-info px-6">Home</a>
                            </div>
                        </div>
                        <!-- end::failed alert -->
