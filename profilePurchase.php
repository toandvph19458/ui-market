                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-3 dataTable"
                                                ...
                                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0"
                                                    ...
                                                    <th class="text-start min-w-100px dt-orderable-none"
                                                        data-dt-column="2" rowspan="1" colspan="1"><span
                                                            ...
                                                            class="dt-column-order"></span></th>
                                                    <th class="text-start min-w-100px min-w-md-80px dt-orderable-none dt-type-numeric"
                                                        data-dt-column="3" rowspan="1" colspan="1"><span
                                                            class="dt-column-title">status</span><span
                                                            class="dt-column-order"></span></th>
                                                    <th class="text-end min-w-60px dt-orderable-none dt-type-numeric"
                                                        data-dt-column="4" rowspan="1" colspan="1"><span
                                                            class="dt-column-title">download</span><span
                                                            class="dt-column-order"></span></th>
                                                    <!--end::Table row-->
                                            </thead>
                                            <!--end::Table head-->
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                <tr>
                                                    ...
                                                    <td class="text-start">
                                                        <span class="text-gray-800 fw-bolder">Free</span>
                                                    </td>
                                                    ...
                                                    <td class="text-end">
                                                        <button
                                                            class="py-2 px-4 fs-7 btn btn-light-info">Download</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                        ...
                        <div class="d-none card card-flush h-xl-100 p-12">
                            <div class="d-flex flex-column container-xxl justify-content-center align-items-center">
                                ...
                                <img class="w-250px h-250px my-10 my-md-20" src="assets/media/icons/duotune/icon/statistics.svg"
                                    alt="">
