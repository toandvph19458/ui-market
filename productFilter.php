...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
    ...
    <!--begin::Main-->
    <!--begin::Root-->
    <div class="d-flex flex-column flex-root" data-select2-id="select2-data-143-e1gn">
        <!--begin::Page-->
        <div class="page d-flex flex-row flex-column-fluid" data-select2-id="select2-data-142-jteo">
            <!--begin::Wrapper-->
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper"
                data-select2-id="select2-data-kt_wrapper">
                <!--begin::Header-->
                ...
                <div id="kt_content_container"
                    class="d-flex flex-column-fluid align-items-start container-xxl mt-9 mt-lg-13"
                    ...
                    <div class="content flex-row-fluid" id="kt_content" data-select2-id="select2-data-kt_content">
                        ...
                        <div class="row d-flex flex-column-reverse flex-lg-row g-8 g-md-4 g-lg-8"
                            data-select2-id="select2-data-141-qg43">

                            <div class="col-12 col-lg-9">
                                <!--begin::Layout-->
                                <div class="flex-lg-row-fluid" data-select2-id="select2-data-140-pdgq">

                                    <!--begin::Toolbar-->
                                    <div class="d-flex flex-wrap flex-stack" data-select2-id="select2-data-139-gyg8">
                                        <!--begin::Title-->
                                        ...
                                        <!--begin::Controls-->
                                        <div class="d-flex flex-column gap-3 gap-lg-0 flex-md-row flex-wrap"
                                            data-select2-id="select2-data-138-718e">

                                            <!--begin::Actions-->
                                            <div class="d-flex my-0">
                                                <!--begin::Select-->
                                                <select name="status" data-control="select2" data-hide-search="true"
                                                    data-placeholder="Filter" id="formatList"
                                                    class="form-select form-select-sm form-select-solid w-200px me-5">
                                            ...
                                            <div class="d-flex my-0">
                                                ...
                                                <select name="status" data-control="select2" data-hide-search="true"
                                                    ...
                                                    class="form-select form-select-sm form-select-solid mw-175px">
                                    ...
                                    <!--begin:: product list-->
                                    <div class="row g-8 g-md-4 g-lg-8 mt-1" id="product-list" data-columns="4">

                                    </div>
                                    <!--end:: product list-->

                                    <div class="d-flex flex-column container-xxl mt-9 justify-content-center">
                                        <button
                                            class="btn btn-flex btn-light-info flex-center align-self-center fw-bold"
                                            id="view-more" style="display:none;">
                                            View more
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <!--begin::Aside-->
                                <div class="flex-column flex-lg-row-auto w-100 mb-8 mb-lg-0">
                                    <!--begin::Form-->
                                    <form action="#">
                                        <!--begin::Card-->
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <!--begin::Input group-->
                                                <label
                                                    class="fs-6 form-label fw-bold text-gray-900 mb-5">Categories</label>
                                                <div id="categoryList" class="mb-10">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="../ass/media/avatars/300-14.jpg" alt="img">
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
