...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="bgi-no-repeat bgi-position-y-bottom bgi-position-x-top bgi-size-cover d-flex justify-content-center align-items-start rounded-6 px-10 py-10 py-lg-10 mb-lg-10 mb-20 mt-5 h-900px"
                            style="background-image: url(assets/media/misc/stats-visuals.png)">

                            <!--begin::Stats wrapper-->
                            <div class="d-flex flex-center flex-column pt-6 pb-20">
                                <!--begin::Heading-->
                                <div class="d-flex flex-column flex-center mb-6">
                                    <!--begin::Title-->
                                    <h1 class="text-white fs-2x fw-bold letter-spacing">
                                        Redesign Challenge
                                    </h1>
                                    <!--end::Title-->

                                    <!--begin::Subtitle-->
                                    <h3 class="d-flex text-white fs-2hx fw-bolder mb-12">
                                    ...
                                    <!--begin::Description-->
                                    <div class="text-center fs-4 fw-semibold w-750px">
                                        <span class="text-white opacity-75">In this week's SheCodes Athena AI Redesign
                                            Challenge, we're calling on you to reimagine the interface of this intuitive
                                ...
                                <!--begin::Numbers-->
                                <div class="d-flex flex-column flex-md-row flex-wrap align-items-center justify-content-center justify-content-lg-between mx-auto mb-10">
                                    <div class="stats-value-bg d-flex flex-column flex-center h-175px w-175px h-lg-200px w-lg-200px my-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                        style="background-image: url('assets/media/svg/shapes/stats-value-shape-bg.svg')">
                                        <div class="fw-bold fs-6 mb-0" style="color: #A2F4C7">
                                            Time left </div>

                                        <div class="fs-1 fw-bolder text-white text-center d-flex flex-center">
                                            <div class="min-w-70px counted">10 Days</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="stats-value-bg d-flex flex-column flex-center h-175px w-175px h-lg-200px w-lg-200px my-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                        ...
                                        <div class="fs-1 fw-bolder text-white text-center d-flex flex-center">
                                            <div class="min-w-70px counted d-flex align-items-center gap-2">10
                                                <img alt="coin" src="assets/media/icons/duotune/icon/coin.svg"
                                                    class="ki-duotone fs-2 p-0 m-0 h-25px w-25px">
                                            </div>
                                    ...
                                    <div class="stats-value-bg d-flex flex-column flex-center h-175px w-175px h-lg-200px w-lg-200px my-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                        ...
                                        <div class="fs-1 fw-bolder text-white text-center d-flex flex-center">
                                            <div class="min-w-70px counted">100.000</div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex flex-row align-items-center gap-4">
                                    <div>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_rules"
                                            class="btn btn-flex flex-center align-self-center btn-light-info fs-6 fw-bold"
                                            id="view-more">View rule
                                        </a>
                                  
                                    </div>
                                    <div>
                                        <a href="challengesCompleted.php"
                                            class="btn btn-flex flex-center align-self-center btn-warning fs-6 fw-bold text-uppercase"
                                            id="view-more">submit my work
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    <?php include 'modal/modalRules.php' ?>
    <!--end::Modal - get coin-->
