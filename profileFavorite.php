                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <!--end::Card title-->
                                <!--begin::Card toolbar-->
                                <div class="card-toolbar flex-row-fluid justify-content-start justify-content-md-end gap-5">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-3 dataTable"
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0"
                                                    ...
                                                    <th class="text-start min-w-150px dt-orderable-none"
                                                        data-dt-column="1" rowspan="1" colspan="1"><span
                                                            class="dt-column-title">purchase date</span><span
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="assets/account/overview.html"
                                                                    class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">All-Access
                                                                    Pass</a>
                                                                <span
                                                    ...
                                                    <td class="text-start">
                                                        <span
                                                            class="badge py-3 px-4 fs-7 badge-light-success">Enable</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-start">
                                                        <span
                                                            class="badge py-3 px-4 fs-7 badge-light-danger">Disable</span>
                                                    </td>
                        ...
                        <div class="d-none card card-flush h-xl-100 p-12">
                            <div class="d-flex flex-column container-xxl justify-content-center align-items-center">
                                <h1 class="page-heading text-center text-gray-900 fw-bold fs-1 m-0 mx-auto">
                                ...
                                <img class="w-250px h-250px my-10 my-lg-20" src="assets/media/icons/duotune/icon/statistics.svg"
                                    alt="">
                                <button class="btn btn-info  px-6">Explore products</button>
                            </div>
                        </div>
