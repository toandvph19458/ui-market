                                ...
                                <div class="row gap-4 gap-lg-0">
                                    ...
                                    <div class="col-12 col-lg-9">
                                        <div class="p-2 px-lg-4 py-lg-4">
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-1 text-gray-900 mb-4">Licensing agreement</h1>
                                                <!--end::Title-->

                                                <!--begin::Text-->
                                                <div class="fs-4 text-gray-700 fw-semibold">
                                                    Here's what our UI Market License allows for, for each Item
                                                    available
                                                    for purchase or download on ui8.net. If you are purchasing for
                                                    multiple
                                                    individuals in your team, please support the authors and add the
                                                    appropriate team size license to your cart during checkout:
                                                </div>
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700">
                                                    <li>
                                                        <span class="">The UI Market License grants the user an
                                                            ongoing,
                                                            non-exclusive, worldwide license to utilize the digital
                                                            work
                                                            (“Item”).</span>
                                                    </li>

                                                    <li>
                                                        <span class="">You are licensed to use the Item to create
                                                            unlimited
                                                            end projects for yourself or for your clients and the
                                                            end
                                                            projects may be sold, licensed, sub-licensed or freely
                                                            distributed.</span>
                                                    </li>
                                                </ul>
                                                <!--end::Text-->
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">What you CAN do:</h1>
                                                <!--end::Title-->

                                                <!--begin::Text-->
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>Create End Products for clients or personal
                                                            projects</span>
                                                    </li>

                                                    <li>
                                                        <span>License, sub-license and make any number of copies of
                                                            end
                                                            projects for
                                                            personal or client engagements.</span>
                                                    </li>
                                                    <li>
                                                        <span>You may modify or manipulate the Item. You may combine
                                                            the
                                                            Item with
                                                            other works and make a derivative work from it. The
                                                            resulting
                                                            works are
                                                            subject to the terms of this license.</span>
                                                    </li>
                                                    <li>
                                                        <span>This is a 'multi-use' license, which means you may use
                                                            an Item
                                                            multiple
                                                            times, in multiple projects.</span>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">What you CANNOT do:
                                                </h1>
                                                <!--end::Title-->
                                                ...
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>Re-distribute the Item as a stock image or it’s source
                                                            files, regardless of any modifications, under any
                                                            circumstances. In other words, you cannot replicate or
                                                            make modifications to the item and sell it on UI8 or
                                                            other marketplaces as your own, even if the source files
                                                            are not included.</span>
                                                    </li>

                                                    <li>
                                                        <span>Make a theme, template or derivative work of any
                                                            product to sell on any marketplace.</span>
                                                    </li>
                                                    <li>
                                                        <span>Resell or otherwise distribute downloaded assets on
                                                            any marketplace including UI8, as well as via private
                                                            channels and bots under any circumstances.</span>
                                                    </li>
                                                    <li>
                                                        <span>Note: Violation of these terms will be pursued to the
                                                            fullest extent of the law.</span>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">Sample end products:
                                                </h1>
                                                <!--end::Title-->
                                                ...
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>End Products include but are not limited to:
                                                            Commercial or personal websites, mobile apps, web apps,
                                                            games, illustrations, wireframes, presentations and
                                                            videos.</span>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">Other licensing terms:
                                                </h1>
                                                <!--end::Title-->
                                                ...
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>For some Items, a component of the Item will be
                                                            sourced by the author from elsewhere and different
                                                            license terms may apply to the component, such as
                                                            someone else’s license or an open source or creative
                                                            commons license. If so, the component will be identified
                                                            by the author in the Item’s description page or in the
                                                            Item’s downloaded files. The other license will apply to
                                                            that component instead of this license. This license
                                                            will apply to the rest of the Item.</span>
                                                    </li>

                                                    <li>
                                                        <span>The author of the Item retains ownership of the Item
                                                            but grants you the license on these terms. This license
                                                            is between the author of the Item and you. UI8.net(UI8)
                                                            is not a party to this license or the one giving you the
                                                            license.</span>
                                                    </li>
                                                </ul>
