            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="notice d-flex align-items-center bg-light-warning rounded border-warning border border-dashed mt-6 p-6">
                            <!--begin::Icon-->
                            <img alt="Logo" src="assets/media/icons/duotune/icon/coin.svg"
                            class="ki-duotone fs-2 p-0 me-5 h-35px w-35px">
                            <!--end::Icon-->
                            ...
                            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                ...
                                <div class="mb-3 mb-md-0 fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">Get 10 FREE coins</h4>
                                    
                                    <div class="fs-6 text-gray-700 pe-7">Don't miss out! <a class="text-info" href="#">Earn 10 extra coins</a> when you make your first coin purchase.</div>
                                    </div>
                                    <!--end::Content-->
                                    
                                    <!--begin::Action-->
                                    <a href="#" class="btn btn-info px-6 align-self-center text-nowrap">Claim</a>
                                    <!--end::Action-->
                                </div>
                                <!--end::Wrapper-->
                            </div>
                        ...
                        <!--begin:: Trending Design Files-->
                        <div class="d-flex flex-column mt-9">
                            <div class="d-flex align-content-end">
                                <img style="width: 24px;height: 24px;" src="assets/media/svg/card-logos/dark/flame.svg"
                                    alt="">
                                <h1 class="page-heading text-gray-900 fw-bold fs-1 m-0 ms-2">
                                    Trending Design Files
                                </h1>
                        ...
                        <div class="row g-8 g-md-4 g-lg-8 mt-1" id="product-trend-list" data-columns="3">
                        ...
                        <!--end::Trending Design Files-->
                        <!--begin:: browse by software-->
                        <?php include 'components/softwareIcon.php' ?>
                        <!--end::browse by software-->
                        <!--begin:: Today-->
                        <div class="d-flex flex-column mt-9">
                            <div class="d-flex align-content-end">
                        ...
                        <?php include './components/engageWidget.php' ?>
                        <!--end::Engage widget 4-->
