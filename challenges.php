    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <!--begin::Container-->
                <!--begin::Container-->
                <!-- begin:: challenges brand -->
                <div class="bg-brand mb-5 mb-lg-15 ">
                        ...
                        <div class="pt-10 pt-xl-20">
                            ...
                            <div class="row pt-lg-10">
                                ...
                                <div class="col-12 col-lg-6 order-2 order-lg-1">
                                    <!--begin::Preview-->
                                    <div class="w-100 pe-lg-20">
                                        <!--begin::Preview light-->
                                        <div>
                                            <img class="mw-100"
                                                src="assets/media/svg/brand-logos/light.png" alt="">
                                        </div>
                                        <!--end::Preview light-->
                                ...
                                <!--begin::Col-->
                                <div class="col-12 col-lg-6 order-1 order-lg-2 mb-10 mb-lg-0">
                                    <!--begin::Block-->
                                    <div class="ms-0 ms-lg-10 ms-xl-0 mt-14">
                                        <!--begin::Heading-->
                                        <h1 class="fs-1 fs-lg-2x fw-bolder text-gray-900 mb-5 letter-spacing mt-n1">
                                            Challenges
                                        </h1>
                                        <!--end::Heading-->

                                        <!--begin::Text-->
                                        <div class="fs-6 fs-xl-3 fw-semibold text-gray-800 mb-5">
                                            We launch contests regularly so you can practice your craft, gain exposure
                                            and earn great prizes. Explore our open challenges and submit your work!
                                        </div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Block-->
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="mt-9">
                            <h1 class="page-heading text-gray-900 fw-bolder fs-2 m-0 me-8">
                                Active Challenges
                            </h1>

                            <div class="d-flex flex-wrap align-items-center mt-6">
                                <div class="col-12 col-md-10 d-flex gap-4">
                                    <img class="rounded-4" src="assets/media/products/product23.svg" alt="">
                                    <div class="d-flex flex-column justify-content-center align-items-center ms-4">
                                        <h4 class="text-gray-800 fw-bold text-hover-primary mb-1 fs-4">She Codes Athena AI Redesign Challenge</h4>
                                        <span class="text-gray-500 fw-semibold d-block fs-5">Get ready for the upcoming design challenge!</span>
                                    </div>
                                </div>

                                <div class="col-12 col-md-2 d-flex flex-end gap-3 mt-3">
                                    <a href="challengesJoin.php"
                                        class="btn btn-flex flex-center align-self-center btn-light-warning fs-6 fw-bold"
                                        id="view-more">Vote
                                    </a>
                                    <a href="challengesJoin.php"
                                        class="btn btn-flex flex-center align-self-center btn-light-primary fs-6 fw-bold"
                                        id="view-more">Join
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center mt-6">
                                <div class="col-10 d-flex gap-4">
                                    <img class="rounded-4" src="assets/media/products/product23.svg" alt="">
                                    <div class="d-none d-md-flex flex-column justify-content-center align-items-center ms-4">
                                        <h4 class="text-gray-800 fw-bold text-hover-primary mb-1 fs-4">She Codes Athena AI Redesign Challenge</h4>
                                        <span class="text-gray-500 fw-semibold d-block fs-5">Get ready for the upcoming design challenge!</span>
                                    </div>
                                </div>

                                <div class="col-2 d-flex flex-end gap-3">
                                    <a href="challengesJoin.php"
                                        class="btn btn-flex flex-center align-self-center btn-light-warning fs-6 fw-bold"
                                        id="view-more">Vote
                                    </a>
                        ...
                        <div class="mt-15">
                            ...
                            <div>
                                <div class="d-flex justify-content-between align-items-center mt-6">
                                    <h1 class="page-heading text-gray-800 fw-bold fs-3 m-0 me-8">
                                        E-mail Client Challenge
                                    </h1>
                                    <div>
                                        <a href="#" class="btn btn-primary">More products</a>
                                    </div>
                                </div>
