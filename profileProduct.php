...
<head>
    <title>Profile my product</title>
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <!--begin::Card toolbar-->
                                <div
                                    class="card-toolbar flex-row-fluid justify-content-between justify-content-md-end gap-md-5">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="#"
                                            class="btn btn-flex flex-center btn-light-primary align-self-center align-items-center px-3 w-md-auto h-35px"
                                            data-bs-toggle="modal" data-bs-target="">
                                            <img alt="Logo" src="assets/media/icons/duotune/icon/coin.svg"
                                                class="ki-duotone fs-2 p-0 h-16px w-16px">
                                            <span class=" ms-3 fs-5 fw-bold">Payout</span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="#"
                                            class="btn btn-flex flex-center btn-primary align-self-center align-items-center px-3 w-md-auto h-35px"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_create_new_product">
                                            <i class="ki-duotone ki-plus-square fs-2 p-0"><span class="path1"></span><span
                                                    class="path2"></span><span class="path3"></span><span
                                                    class="path4"></span>
                                            </i>
                                            <span class="d-none d-md-inline ms-3 text-uppercase fs-base">Create
                                                new</span>
                                        </a>
                                    </div>
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div id="kt_table_widget_4_table_wrapper"
                                    ...
                                    <div id="" class="table-responsive">
                                        <table class="table align-middle table-row-dashed fs-6 gy-3 dataTable"
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0"
                                                    role="row">
                                                    <th class="min-w-360px dt-orderable-none" data-dt-column="0"
                                                        rowspan="1" colspan="1"><span class="dt-column-title">Item &
                                                            descriptions</span><span class="dt-column-order"></span>
                                                    </th>
                                                    <th class="text-start min-w-125px dt-orderable-none"
                                                        data-dt-column="1" rowspan="1" colspan="1"><span
                                                            class="dt-column-title">upload date</span><span
                                                            class="dt-column-order"></span></th>
                                                    <th class="text-start min-w-100px dt-orderable-none"
                                                        data-dt-column="2" rowspan="1" colspan="1"><span
                                                            class="dt-column-title">pricings</span><span
                                                            class="dt-column-order"></span></th>
                                                    <th class="text-start min-w-60px dt-orderable-none dt-type-numeric"
                                                        data-dt-column="3" rowspan="1" colspan="1"><span
                                                            class="dt-column-title">status</span><span
                                                            class="dt-column-order"></span></th>
                                                    <th class="text-center min-w-70px dt-orderable-none"
                                                        data-dt-column="4" rowspan="1" colspan="1"><span
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="assets/account/overview.html"
                                                                    class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">All-Access
                                                                    Pass</a>
                                                                <span
                                                                    class="text-gray-500 fw-semibold d-block fs-7">Rental
                                                                    car App Mobile UI KIT</span>
                                                            </div>
                                                        </div>
                                                    </td>

                                                    <td class="text-start">
                                                        <span class="text-gray-800 fw-bolder">Sep 9, 2020</span>
                                                    </td>

                                                    <td class="text-start">
                                                        <span class="text-gray-800 fw-bolder">10</span>
                                                        <img alt="Logo" src="assets/media/icons/duotune/icon/coin.svg"
                                                            class="ki-duotone fs-2 p-0 ms-1 h-16px w-16px mb-1">
                                                    </td>

                                                    <td class="text-start">
                                                        <span
                                                            class="badge py-3 px-4 fs-7 badge-light-success">Active</span>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="me-0">
                                                            ...
                                                            <!--begin::Menu -->
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-125px shadow"
                                                                data-kt-menu="true" style="">
                                                                <!--begin::Menu item-->
                                                                <div class="menu-item p-2">
                                                                    <a href="#" class="menu-link px-4 py-3">
                                                                        <i
                                                                            class="ki-duotone ki-pencil fs-3 text-gray-500 me-2"><span
                                                                    ...
                                                                    <a href="#" class="menu-link px-4 py-3">
                                                                        <i
                                                                            class="ki-duotone ki-basket fs-3 text-gray-500 me-2"><span
                                                                                class="path1"></span><span
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-start">
                                                        <span
                                                            class="badge py-3 px-4 fs-7 badge-light-danger">Inactive</span>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="me-0">
                                                            ...
                                                            <!--begin::Menu -->
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-125px shadow-sm"
                                                                data-kt-menu="true" style="">
                                                                <!--begin::Menu item-->
                                                                <div class="menu-item p-2">
                                                                    <a href="#" class="menu-link px-4 py-3">
                                                                    ...
                                                                    <a href="#" class="menu-link px-4 py-3">
                                                                        <i
                                                                            class="ki-duotone ki-arrows-circle fs-3 text-gray-500 me-2"><span
                                                                                class="path1"></span><span
                                                                                class="path2"></span><span
                                                                                class="path3"></span><span
                                                                                class="path4"></span></i>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-start">
                                                        <span
                                                            class="badge py-3 px-4 fs-7 badge-light-warning">Draft</span>
                                                    </td>
                                        ...
                                        <!-- Begin:: view more -->
                                        <?php include './components/viewMore.php' ?>
                                        <!-- end:: view more -->
                                    </div>
                                    <div id="" class="row">
                                        <div id=""
                        ...
                        <!-- begin::none product alert -->
                        <div class="d-none card card-flush h-xl-100 p-12">
                            <div
                                class="d-flex flex-column container-xxl mt-12 justify-content-center align-items-center">
                                <h1 class="page-heading text-gray-900 text align-items-center fw-bold fs-1 m-0 mx-auto">
                                    You do not have any products yet.
                                </h1>
                                <img class="w-250px h-250px my-10 my-lg-20" src="assets/media/icons/duotune/icon/statistics.svg"
                                    alt="">
                                <a href="author.php" class="btn btn-info px-6">Become an author</a>
                            </div>
                        </div>
                        <!-- end::none product alert -->
                        <!-- end::content -->
    ...
    <!--begin::Modal - get coin -->
    <?php include 'modal/modalNewProduct.php' ?>
    <!--end::Modal - get coin-->
</body>
