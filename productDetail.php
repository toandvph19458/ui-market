...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
                    <div class="content flex-row-fluid" id="kt_content">
                        <!--begin::brand-->
                        <div id="brander_download_product" class="card border-transparent mt-6 min-h-250px border-0 bgi-size-cover bgi-position-center bgi-no-repeat">
                            <div class="w-100 min-h-250px px-2 px-md-10 d-flex align-items-end rounded-4"
                                style="background-color: rgba(0,0,0,0.9);">
                                <!--begin::Body-->
                                <div class="card-body px-3 flex-fill">
                                    <h1 class="fs-2 fs-md-2x fw-semibold text-white" id="productTitle">
                                    </h1>
                                    <span class="fs-4 fw-semibold text-white" id="productDescription"></span>
                                    <div class="d-flex flex-column flex-md-row justify-content-between gap-md-0 gap-3">
                                        <div class="mt-3 d-flex gap-2 align-items-center">
                                            <img class="w-20px h-20px" src="assets/media/avatars/ava.svg" alt="">
                                            <span class="text-white fw-semibold fs-7">Ozenua Cand</span>
                                            <div class="d-flex align-items-center"><img class="" alt=""
                                                    src="assets/media/icons/duotune/icon/play_white.svg"></div>
                                            <span class="text-white fw-semibold fs-7">UI Kits</span>
                                            <div class="d-flex align-items-center"><img class="" alt=""
                                                    src="assets/media/icons/duotune/icon/play_white.svg"></div>
                                            <div id="productFormatIcons" class="d-flex gap-2 h-16px">
                                                
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between gap-3 gap-lg-5">
                                            <div class="d-flex align-items-center fw-bold fs-7 badge rounded-pill p-0">
                                                <a href="#"
                                                    class="bg-black rounded-pill py-4 px-5 d-flex align-items-center">
                                                    <div
                                                        class="icon_heart_group position-relative d-flex align-items-center justify-content-center">
                                                        <img class="opacity-100"
                                                            src="assets/media/icons/duotune/icon/heart.svg" alt="">
                                                        <img class="icon_heart_white position-absolute top-50 translate-middle-y opacity-0"
                                                            style=""
                                                            src="assets/media/icons/duotune/icon/heartwhite.svg" alt="">
                                                        <img class="icon_heart_pink position-absolute top-50 translate-middle-y d-none"
                                                            style=""
                                                            src="assets/media/icons/duotune/icon/pink_heart.svg" alt="">
                                                    </div>
                                                    <span class="text-light ms-2 mt-1">8</span>
                                                </a>
                                            </div>

                                            <div
                                                class="d-flex align-items-center fw-bold fs-7 badge btn btn-light-primary bg-black rounded-pill p-0">
                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_product_preview"
                                                    class="py-4 px-5 d-flex align-items-center">
                                                    <img src="assets/media/icons/duotune/icon/eye_white.svg" alt="">
                                                    <span class="text-light ms-2 mt-1">Preview</span>
                                                </a>
                                            </div>

                                            <div class="d-flex align-items-center">
                                                <a href="#"
                                                    class="btn btn-flex flex-center btn-success align-self-center px-4 px-md-5 w-md-auto h-lg-40px">
                                                    <span class="me-2 text-uppercase fw-bold text-white"
                                                        id="productPrice">Get
                                                        it now 10</span>
                                                    <img alt="Logo" src="assets/media/icons/duotune/icon/coin.svg"
                                                        class="ki-duotone fs-2 p-0 m-0 h-16px w-16px">
                                                </a>
                                            </div>
                                            <div class="d-none align-items-center">
                                                <a href="#"
                                                    class="btn btn-flex flex-center align-self-center px-4 px-md-5 w-md-auto h-lg-40px text-uppercase fw-bold text-white"
                                                    style="background-color:#47BE7D;">
                                                    Download
                                                </a>Down
                                            </div>
                                        </div>
                        ...
                        <!--begin::product list detail-->
                        <div class="row g-8 g-md-5 g-xl-10 mb-xl-10 mt-6" id="productImages">

                        </div>
                        <!--end::product list detail-->

                        <!--begin::overview and highlight-->
                        <div class="row gx-5 gx-xl-10 mb-xl-10 mt-4 mt-lg-13">
                            <div class="col-md-6 col-lg-6 col-xl-6 mb-10 rounded-4">
                                <h2 class="fs-2 fw-bold">Overview</h2>
                                <div class="fs-3 fw-bold text-gray-600 my-5">
                                    <div>Cardealy - Rental car App UI KIT</div>
                                    <div>Build a professional Rental car App Mobile UI KIT with this UI KIT.</div>
                                </div>

                                <div class="d-flex">
                                    <div class="me-4">
                                        <img src="assets/media/icons/duotune/icon/question-2.svg" alt="">
                                    </div>
                                    <div>
                                        <span class="fs-4 text-gray-700 fw-bold">What will you get</span>
                                        <ul class="d-flex flex-column fs-5 text-gray-500 fw-semibold gap-4 mt-6">
                                            <li
                                                style="list-style-image:url('assets/media/icons/duotune/icon/minus.svg')">
                                                100+ Screens</li>
                                            <li
                                                style="list-style-image:url('assets/media/icons/duotune/icon/minus.svg')">
                                                Figma-Based</li>
                                            <li
                                                style="list-style-image:url('assets/media/icons/duotune/icon/minus.svg')">
                                                Well organize layer</li>
                                            <li
                                                style="list-style-image:url('assets/media/icons/duotune/icon/minus.svg')">
                                                Dark Mode and Light Mode</li>
                                            <li
                                                style="list-style-image:url('assets/media/icons/duotune/icon/minus.svg')">
                                                Fully Customizable</li>
                                            <li
                                                style="list-style-image:url('assets/media/icons/duotune/icon/minus.svg')">
                                                Free use google font</li>
                                            <li
                                                style="list-style-image:url('assets/media/icons/duotune/icon/minus.svg')">
                                                Guide for Design System</li>
                                        </ul>
                                    </div>
                                </div>
                                <span class="fs-3 fw-bold text-gray-600 my-5">100% vector editable and scalable. The
                                    color is easy to
                                    change. Each illustration
                                    is organized, named & very easy to use.</span>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6 mb-10 rounded-4">
                                <h2 class="fs-2 fw-bold">Highlight</h2>
                                <ul
                                    class="d-flex flex-column fs-5 text-gray-500 fw-semibold gap-4 mt-6 list-style-none p-0">
                                    <li class="d-flex align-items-center">
                                        <img class="me-2" src="assets/media/icons/duotune/icon/check-circle.svg"
                                            alt="Check">
                                        100+ Screens
                                    </li>
                                    <li class="d-flex align-items-center">
                                    ...
                                    <li class="d-flex align-items-center">
                                        <img class="me-2" src="assets/media/icons/duotune/icon/check-circle.svg"
                                            alt="Check">
                                        Guide for Design System
                                    </li>
                                </ul>
                                <h2 class="fs-2 fw-bold my-5">Format</h2>
                                <div id="productFormatIcons" class="d-flex gap-3 h-36px">
                                    
                                </div>
                                <div class="d-flex align-items-center gap-4 mt-5">
                                    <img src="assets/media/icons/duotune/icon/download.svg" alt="">
                                    <a class="fs-5 text-gray-500 fw-semibold" href="">150.6 MB in1 File</a>
                                </div>
                            </div>

                        </div>
                        <!--end::overview and highlight-->
                        ...
                        <!-- begin:: product list-->
                        <div class="row g-8 g-md-4 g-lg-8 mt-1" id="product-list" data-columns="3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link flex-stack px-3" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_product_preview">Invite Contacts
    ...
    <!--end::Scrolltop-->
    <!--begin::Modals-->
    <!--begin::Modal - product preview-->
    <div class="modal fade" id="kt_modal_product_preview" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div id="kt_content_container" class="modal-dialog modal-dialog-centered modal-xxl">
            <!--begin::Modal content-->
            <div class="modal-content py-7 px-6">
                <!--begin::Modal header-->
                <div class="d-flex flex-row justify-content-end justify-content-md-between mb-6">
                    <div class="mt-3 d-none d-md-flex gap-2 align-items-center justify-content-between">
                        <span id="productTitle" class="fs-2 fw-bold">Cardealy - Rental car App Mobile UI KIT</span>
                    </div>
                    <div class="d-flex gap-2 gap-lg-4">
                        <div class="d-flex align-items-center fw-bold fs-7 badge rounded-pill p-0">
                            <a href="#" class="bg-gray-300 rounded-pill py-4 px-5 d-flex align-items-center">
                                <div
                                    class="icon_heart_group position-relative d-flex align-items-center justify-content-center">
                                    <img class="opacity-100" src="assets/media/icons/duotune/icon/heart_black.svg"
                                        alt="">
                                    <img class="icon_heart_white position-absolute top-50 translate-middle-y opacity-0"
                                        style="left:0;" src="assets/media/icons/duotune/icon/heartwhite.svg" alt="">
                                    <img class="icon_heart_pink position-absolute top-50 translate-middle-y d-none"
                                        style="" src="assets/media/icons/duotune/icon/pink_heart.svg" alt="">
                                </div>
                                <span class="text-gray-900 fw-bold fs-4 ms-2">8</span>
                            </a>
                        </div>
                        <div class="d-flex align-items-center">
                            <a href="#"
                                class="btn btn-flex flex-center btn-success align-self-center px-4 px-md-5 w-md-auto h-lg-40px">
                                <span id="productPrice" class="me-2 text-uppercase fw-bold text-white">Get
                                    it now 10</span>
                                <img alt="Logo" src="assets/media/icons/duotune/icon/coin.svg"
                                    class="ki-duotone fs-2 p-0 m-0 h-16px w-16px">
                            </a>
                        ...
                        <div class="d-none align-items-center">
                            <a href="#"
                                class="btn btn-flex flex-center align-self-center px-4 px-md-5 w-md-auto h-lg-40px"
                                style="background-color:#47BE7D;">
                                <span class="text-uppercase fw-bold text-white">Download</span>
                            </a>
                        </div>
                        <!--end::download btn-->


                        <div class="btn btn-sm btn-icon btn-active-color-primary ms-2 ms-lg-5" data-bs-dismiss="modal">
                ...
                <div class="w-100 h-1px bg-gray-200 mb-6"></div>

                <!--begin::Modal body-->
                <div>
                    <div id="productImagesModal">

                    </div>
                    <div class="text-center my-10 my-lg-20 d-block">
                        <h1 class="fs-xl-2tx fw-bold text-gray">Global Design System</h1>
                        <div class="w-lg-400px fs-5 text-gray-400 fw-semibold mt-6 m-auto">With the global style guide
                            in
                            place, managing content, layout, and color has become a
                            streamlined process</div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="d-flex align-items-center px-auto mt-6">
                            <a href="#"
                                class="btn btn-flex flex-center align-self-center px-4 px-md-5 w-md-auto h-lg-40px"
                                style="background-color:#47BE7D;">
                                <span id="productPrice" class="me-2 text-uppercase fw-bold text-white">Get
                        ...
                        <!--begin::download btn-->
                        <div class="d-none align-items-center px-auto mt-6">
                            <a href="#"
                                class="btn btn-flex flex-center align-self-center px-4 px-md-5 w-md-auto h-lg-40px"
                                style="background-color:#47BE7D;">
                                <span class="text-uppercase fw-bold text-white">Download</span>
