...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="mt-7">
                            <!--begin::Title-->
                            <h1 class="fs-2x text-gray-900 mb-6">Licensing, Terms & Policy</h1>
                            <!--end::Title-->

                            <!--begin::Text-->
                            <div class="fs-5 text-gray-600 fw-semibold">
                                Please take the time to thoroughly review the crucial information regarding our
                                licensing terms of use and other policies provided on this page.
                            </div>
                            <!--end::Text-->
                        </div>
                        <!-- end::heading -->
                            ...
                            <div class="card-body p-7">
                                <div class="row gap-4 gap-lg-0">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div>
                                                <a href="licensing.php"
                                                    class="d-block justify-content-start rounded px-0 w-100 bg-hover-light-primary text-hover-primary py-4 px-6 fs-5 fw-bold text-gray-500">
                                                    Licensing
                                                </a>
                                            </div>
                                            <!--begin::Contact group-->
                                    ...
                                    <div class="col-12 col-lg-9">
                                        <div class="p-2 px-lg-4 py-lg-4">
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-1 text-gray-900 mb-4">Terms of use</h1>
                                                <!--end::Title-->

                                                <!--begin::Text-->
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>Please read these Terms and Conditions ("Terms",
                                                            "Terms
                                                            and
                                                            Conditions") carefully before using the https://ui8.net/
                                                            website
                                                            and the UI8 mobile application (together, or
                                                            individually,
                                                            the
                                                            "Service") operated by UI8 ("us", "we", or "our").
                                                        </span>
                                                    </li>
                                                    <li>
                                                        <span>Your access to and use of the Service is conditioned
                                                            upon
                                                            your
                                                            acceptance of and compliance with these Terms. These
                                                            Terms
                                                            apply
                                                            to all visitors, users and others who wish to access or
                                                            use
                                                            the
                                                            Service.
                                                        </span>
                                                    ...
                                                    <li>
                                                        <span>By accessing or using the Service you agree to be
                                                            bound by
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">Communications</h1>
                                                <!--end::Title-->

                                                <!--begin::Text-->
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>By creating an Account on our service, you agree to
                                                            subscribe
                                                            to newsletters, marketing or promotional materials.
                                                            However,
                                                            you
                                                            may opt out of receiving some, or all, of these
                                                            communications
                                                            from us by following the unsubscribe link or
                                                            instructions
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">Purchases</h1>
                                                <!--end::Title-->

                                                <!--begin::Text-->
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>If you wish to purchase any product or service made
                                                            available
                                                            through the Service ("Purchase"), you may be asked to
                                                            supply
                                                            certain information relevant to your Purchase including,
                                                            without
                                                            limitation, your credit card number, the expiration date
                                                            of
                                                            your
                                                    ...
                                                    <li>
                                                        <span>You represent and warrant that: (i) you have the legal
                                                            right
                                                    ...
                                                    <li>
                                                        <span>The service may employ the use of third party services
                                                            for
                                                            the
                                                            purpose of facilitating payment and the completion of
                                                            Purchases.
                                                            By submitting your information, you grant us the right
                                                            to
                                                            provide the information to these third parties subject
                                                            to
                                                            our
                                                            Privacy Policy.</span>
                                                    </li>
                                                    <li>
                                                        <span>We reserve the right to refuse or cancel your order at
                                                            any
                                                            time for reasons including but not limited to: product
                                                            or
                                                    ...
                                                    <li>
                                                        <span>We reserve the right to refuse or cancel your order if
                                                            fraud
                                                            or an unauthorized or illegal transaction is
                                                            suspected.</span>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">All-Access Pass
                                                    purchases
                                                </h1>
                                                <!--end::Title-->
                                                ...
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>The UI8 All-Access Pass grants single-user access to
                                                            download
                                                            product downloads on a use by use basis. All products on
                                                            UI8
                                                            are
                                                            available for download during the duration of the Pass
                                                            life.
                                                            Sharing account access with other users, manually mass
                                                            spam
                                                            downloading products, or utilizing a script to mass
                                                            download
                                                            products is strictly prohibited, and can lead to the
                                                            permanent
                                                            ban of the offending account with no refunds.</span>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">Verification</h1>
                                                <!--end::Title-->

                                                <!--begin::Text-->
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>By utilizing UI8.net’s services you agree to verify no
                                                            more
                                                            than a maximum of 5 devices/IP addresses per license.
                                                            Access
                                                            with these 5 Devices are meant to cover the use of 1
                                                            person
                                                            per
                                                            individual license. If additional user or device access
                                                            is
                                                            desired, please reach out to UI8.net’s support team for
                                                            additional licensing. Violation of these terms may
                                                            result in
                                                            the
                                                            immediate ban of your account, and possible permanent
                                                            termination in cases of repeated violations.</span>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">reCAPTCHA</h1>
                                                <!--end::Title-->
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">Availability, Errors
                                                    and
                                                    Inaccuracies</h1>
                                                <!--end::Title-->
                                                ...
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>We are constantly updating product and service
                                                            offerings
                                                            on
                                                            the Service. We may experience delays in updating
                                                            information on
                                                            the Service and in our advertising on other web sites.
                                                            The
                                                            ...
                                                            accuracy
                                                            or completeness of any information found on the
                                                            Service.</span>
                                                    </li>
                                                    <li>
                                                        <span>We therefore reserve the right to change or update
                                                            information
                                                            and to correct errors, inaccuracies, or omissions at any
                                                            time
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">Content</h1>
                                                <!--end::Title-->

                                                <!--begin::Text-->
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>Our Service allows you to post, link, store, share and
                                                            ...
                                                            including
                                                            its legality, reliability, and appropriateness.</span>
                                                        <span>
                                                            By posting Content on or through the Service, You
                                                            represent
                                                            and
                                                            warrant that: (i) the Content is yours (you own it)
                                                            and/or
                                                            you
                                                            have the right to use it and the right to grant us the
                                                            rights
                                                            and license as provided in these Terms, and (ii) that
                                                            the
                                                            posting of your Content on or through the Service does
                                                            not
                                                        ...
                                                        </span><span>You retain any and all of your rights to any
                                                            Content
                                                            you submit, post or display on or through the Service
                                                            and
                                                            you
                                                            are responsible for protecting those rights. We take no
                                                            responsibility and assume no liability for Content you
                                                            or
                                                            any
                                                            third party posts on or through the Service. However, by
                                                            posting
                                                            Content using the Service you grant us the right and
                                                            license
                                                            to
                                                            use, modify, publicly perform, publicly display,
                                                            reproduce,
                                                            and
                                                            ...
                                                            Content
                                                            available to other users of the Service, who may also
                                                            use
                                                            your
                                                            Content subject to these Terms.</span>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="mb-6">
                                                <!--begin::Title-->
                                                <h1 class="fs-3 fw-bolder text-gray-900 mb-4">Accounts</h1>
                                                <!--end::Title-->

                                                <!--begin::Text-->
                                                <ul class="fs-4 fw-semibold my-1 text-gray-700 list-unstyled">
                                                    <li>
                                                        <span>When you create an account with us, you guarantee that
                                                            you
                                                            are
                                                            above the age of 18, and that the information you
                                                            provide us
                                                            is
                                                            ...
                                                            immediate
                                                            termination of your account on the Service.</span>
                                                    </li>
                                                    <li>
                                                        <span>You are responsible for maintaining the
                                                            confidentiality of
                                                            ...
                                                            You
                                                            agree
                                                            to accept responsibility for any and all activities or
                                                            actions
                                                            ...
                                                            You
                                                            must
                                                            notify us immediately upon becoming aware of any breach
                                                            of
                                                            security or unauthorized use of your account.</span>
                                                    </li>
                                                    <li>
                                                        <span>You may not use as a username the name of another
                                                            person
                                                            or
                                                            entity or that is not lawfully available for use, a name
                                                            or
                                                            trademark that is subject to any rights of another
                                                            person or
                                                            entity other than you, without appropriate
                                                            authorization.
                                                            You
                                                            may not use as a username any name that is offensive,
                                                            vulgar
                                                            or
                                                            obscene.</span>
                                                    </li>
                                                    <li>
                                                        <span>We reserve the right to refuse service, terminate
                                                            accounts,
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        ...
                                        data-hide-search="true" data-select2-id="select2-data-18-y8ov" tabindex="-1"
                                        ...
                                        dir="ltr" data-select2-id="select2-data-19-piv9" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-b5gt-container"
                                                aria-controls="select2-b5gt-container"><span
                                                    class="select2-selection__rendered" id="select2-b5gt-container"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-21-8cqn" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        ...
                                        dir="ltr" data-select2-id="select2-data-22-zoe3" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-msuw-container"
                                                aria-controls="select2-msuw-container"><span
                                                    class="select2-selection__rendered" id="select2-msuw-container"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-24-pk4b" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-25-tnca" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-q1f5-container"
                                                aria-controls="select2-q1f5-container"><span
                                                    class="select2-selection__rendered" id="select2-q1f5-container"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-27-wimp" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-28-7od6" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-r08r-container"
                                                aria-controls="select2-r08r-container"><span
                                                    class="select2-selection__rendered" id="select2-r08r-container"
                                                    role="textbox" aria-readonly="true" title="Owner">Owner</span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-30-dst9" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-31-2l29" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-g9fb-container"
                                                aria-controls="select2-g9fb-container"><span
                                                    class="select2-selection__rendered" id="select2-g9fb-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-33-jgn4" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-34-d23m" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-ih5s-container"
                                                aria-controls="select2-ih5s-container"><span
                                                    class="select2-selection__rendered" id="select2-ih5s-container"
                                                    role="textbox" aria-readonly="true" title="Owner">Owner</span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-36-h92b" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-37-ntn7" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-won5-container"
                                                aria-controls="select2-won5-container"><span
                                                    class="select2-selection__rendered" id="select2-won5-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-39-zyl7" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-40-4s8v" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-qtr3-container"
                                                aria-controls="select2-qtr3-container"><span
                                                    class="select2-selection__rendered" id="select2-qtr3-container"
                                                    role="textbox" aria-readonly="true" title="Owner">Owner</span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-42-ywau" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        ...
                                        dir="ltr" data-select2-id="select2-data-43-9mu1" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-v07t-container"
                                                aria-controls="select2-v07t-container"><span
                                                    class="select2-selection__rendered" id="select2-v07t-container"
                                                    role="textbox" aria-readonly="true" title="Guest">Guest</span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-45-vvrr" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-46-899w" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-w08j-container"
                                                aria-controls="select2-w08j-container"><span
                                                    class="select2-selection__rendered" id="select2-w08j-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-48-ly5d" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-49-ebh3" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-uqga-container"
                                                aria-controls="select2-uqga-container"><span
                                                    class="select2-selection__rendered" id="select2-uqga-container"
                                                    role="textbox" aria-readonly="true" title="Owner">Owner</span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-51-zz4o" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        ...
                                        dir="ltr" data-select2-id="select2-data-52-q13u" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-wosy-container"
                                                aria-controls="select2-wosy-container"><span
                                                    class="select2-selection__rendered" id="select2-wosy-container"
                                                    role="textbox" aria-readonly="true" title="Guest">Guest</span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-54-vw1x" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-55-w7sb" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-syp9-container"
                                                aria-controls="select2-syp9-container"><span
                                                    class="select2-selection__rendered" id="select2-syp9-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-57-ny9n" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-58-lux5" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-scj6-container"
                                                aria-controls="select2-scj6-container"><span
                                                    class="select2-selection__rendered" id="select2-scj6-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-60-0agy" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-61-mnzq" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-goxw-container"
                                                aria-controls="select2-goxw-container"><span
                                                    class="select2-selection__rendered" id="select2-goxw-container"
                                                    role="textbox" aria-readonly="true" title="Owner">Owner</span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-63-pv6y" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        ...
                                        dir="ltr" data-select2-id="select2-data-64-0r2h" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-0l7q-container"
                                                aria-controls="select2-0l7q-container"><span
                                                    class="select2-selection__rendered" id="select2-0l7q-container"
                                                    role="textbox" aria-readonly="true" title="Guest">Guest</span><span
                                                    class="select2-selection__arrow" role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
                                            class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="ms-2 w-100px">
                                    <select
                                        class="form-select form-select-solid form-select-sm select2-hidden-accessible"
                                        data-control="select2" data-dropdown-parent="#kt_modal_invite_friends"
                                        data-hide-search="true" data-select2-id="select2-data-66-d5la" tabindex="-1"
                                        aria-hidden="true" data-kt-initialized="1">
                                        <option value="1">Guest</option>
                                        <option value="2">Owner</option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-67-58t5" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid form-select-sm"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-apkc-container"
                                                aria-controls="select2-apkc-container"><span
                                                    class="select2-selection__rendered" id="select2-apkc-container"
                                                    role="textbox" aria-readonly="true" title="Can Edit">Can
                                                    Edit</span><span class="select2-selection__arrow"
                                                    role="presentation"><b
                                                        role="presentation"></b></span></span></span><span
    ...
    <!-- <span class="select2-container select2-container--bootstrap5 select2-container--open"
        style="position: absolute; top: 817.844px; left: 1338.03px;"><span
            class="select2-dropdown select2-dropdown--above" dir="ltr" style="width: 125px;"><span
                class="select2-search select2-search--dropdown select2-search--hide"><input
                    class="select2-search__field" type="search" tabindex="0" autocorrect="off" autocapitalize="none"
                    spellcheck="false" role="searchbox" aria-autocomplete="list" autocomplete="off" aria-label="Search"
                    aria-controls="select2-sugu-results" aria-activedescendant="select2-sugu-result-6mst-4"></span><span
                class="select2-results">
                <ul class="select2-results__options" role="listbox" id="select2-sugu-results" aria-expanded="true"
                    aria-hidden="false">
                    <li class="select2-results__option select2-results__option--selectable"
                        id="select2-sugu-result-o1ez-1" role="option"
                        data-select2-id="select2-data-select2-sugu-result-o1ez-1" aria-selected="false">1 Hours</li>
                    <li class="select2-results__option select2-results__option--selectable"
                        id="select2-sugu-result-ab5n-2" role="option"
                        data-select2-id="select2-data-select2-sugu-result-ab5n-2" aria-selected="false">6 Hours</li>
                    <li class="select2-results__option select2-results__option--selectable"
                        id="select2-sugu-result-7anx-3" role="option"
                        data-select2-id="select2-data-select2-sugu-result-7anx-3" aria-selected="false">12 Hours</li>
                    <li class="select2-results__option select2-results__option--selectable select2-results__option--selected select2-results__option--highlighted"
                        id="select2-sugu-result-6mst-4" role="option"
                        data-select2-id="select2-data-select2-sugu-result-6mst-4" aria-selected="true">24 Hours</li>
                </ul>
            </span></span></span> -->
